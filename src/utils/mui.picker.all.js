...
(function($, document) {
	...
	var PopPicker = $.PopPicker = $.Class.extend({
		...
		hide: function() {
			...
			//新加:点击幕布或取消时，把生成的名为picker的DOM对象清空  date:2018-04-16
			setTimeout(function() {
...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		...
		<div class="mui-dtpicker-title"><h5 id="title-y" data-id="title-y">年</h5><h5 id="title-m" data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="mui-dtpicker-body">\
			<div id="picker-y" data-id="picker-y" class="mui-picker">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
			...
			<div id="picker-m" data-id="picker-m" class="mui-picker">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_createMonth: function(current) {
			...
			if (options.customData.m) {
				...
				if((window.localStorage.getItem('login-db')==='GZL')&&(window.location.href.indexOf('gzt.html')>-1)){//公主岭工资条要13月~
					var maxMonth = options.endMonth && self._isEndYear() ? options.endMonth : 13;
				}else{
